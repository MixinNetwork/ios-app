...
extension MessageCategory {
    ...
    static func iconImage(forMessageCategoryString category: String) -> UIImage? {
        if category.hasSuffix("_IMAGE") {
            return R.image.ic_message_photo()
        } else if category.hasSuffix("_STICKER") {
            return R.image.ic_message_sticker()
        } else if category.hasSuffix("_CONTACT") {
            return R.image.ic_message_contact()
        } else if category.hasSuffix("_DATA") {
            return R.image.ic_message_file()
        } else if category.hasSuffix("_VIDEO") {
            return R.image.ic_message_video()
        } else if category.hasSuffix("_LIVE") {
            return R.image.ic_message_live()
        } else if category.hasSuffix("_AUDIO") {
            return R.image.ic_message_audio()
            ...
            return R.image.ic_message_transfer()
            ...
            return R.image.ic_message_bot_menu()
        } else {
            return nil
        }
    }
