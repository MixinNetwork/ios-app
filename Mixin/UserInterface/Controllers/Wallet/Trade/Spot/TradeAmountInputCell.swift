...
final class TradeAmountInputCell: UICollectionViewCell {
...
extension TradeAmountInputCell {
    
    func updateSendView(style: TradeTokenSelectorStyle) {
    ...
    func updateReceiveView(style: TradeTokenSelectorStyle) {
        switch style {
        case .loading:
