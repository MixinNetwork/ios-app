...
final class AddWalletGuideCell: UICollectionViewCell {
...
extension AddWalletGuideCell: PillActionView.Delegate {
    
    func pillActionView(_ view: PillActionView, didSelectActionAtIndex index: Int) {
        delegate?.addWalletGuideCell(self, didSelectActionAtIndex: index)
    }
