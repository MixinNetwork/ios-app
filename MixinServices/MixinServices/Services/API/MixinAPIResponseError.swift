...
extension MixinAPIResponseError {
    ...
    public static let noAvailableQuote                     = MixinAPIResponseError(status: 202, code: 10611)
    public static let invalidQuoteAmount                   = MixinAPIResponseError(status: 202, code: 10614)
    public static let tokenPairNotSupported                = MixinAPIResponseError(status: 202, code: 10615)
    ...
    public static let perpsOrderMarginTooLow               = MixinAPIResponseError(status: 202, code: 10650)
    public static let alreadyHadPosition                   = MixinAPIResponseError(status: 202, code: 10651)
    public static let exceedsMaxRemovableMargin            = MixinAPIResponseError(status: 202, code: 10653)
    public static let perpsOrderSizeTooLow                 = MixinAPIResponseError(status: 202, code: 10654)
    public static let perpPositionSizeExceedsLeverageLimit = MixinAPIResponseError(status: 202, code: 10655)
    ...
    public static let inviterPlanExpired                   = MixinAPIResponseError(status: 202, code: 10737)
