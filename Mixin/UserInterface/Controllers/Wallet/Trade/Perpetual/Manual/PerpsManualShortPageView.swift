...
struct PerpsManualShortPageView: View {
        ...
        ManualScrollView {
            VStack(spacing: 12) {
                    ...
                    VStack(alignment: .leading, spacing: 16) {
                        ...
                        HStack {
                            ...
                            Text(R.string.localizable.short())
                                ...
                                .background(Color(MarketColor.falling.uiColor))
                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    Spacer()
                        .frame(height: 10)
                    Text(R.string.localizable.perps_short_overview())
                    ...
                    Spacer()
                        .frame(height: 4)
                    BulletinText([
                        R.string.localizable.pnl_rule_price_fall_profit(),
                        R.string.localizable.pnl_rule_price_rise_loss(),
                    ])
                }
                .padding(PerpsManual.cardInsets)
                .frame(maxWidth: .infinity, alignment: .leading)
