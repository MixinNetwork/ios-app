...
final class WalletIntroductionCell: UICollectionViewCell {
    ...
    @IBAction func close(_ sender: Any) {
        switch content {
        case .privacy:
            AppGroupUserDefaults.Wallet.hasViewedPrivacyWalletIntroduction = true
        case .classic:
            AppGroupUserDefaults.Wallet.hasViewedClassicWalletIntroduction = true
        case .safe:
            AppGroupUserDefaults.Wallet.hasViewedSafeWalletIntroduction = true
        case .importedWalletSafety:
    ...
    @IBAction func learnMore(_ sender: Any) {
        ...
        delegate?.walletIntroductionCell(self, requestToLearnMore: url)
    }
