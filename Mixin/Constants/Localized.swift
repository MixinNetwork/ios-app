...
public class Localized {
    ...
    public static let WALLET_PIN_CREATE_TITLE = LocalizedString("wallet_pin_create_title", comment: "Set a 6 digit Wallet PIN to create your first digital wallet")
    public static let WALLET_PIN_CONFIRM_TITLE = LocalizedString("wallet_pin_confirm_title", comment: "Please confirm the 6 digit Wallet PIN and remember it")
    ...
    public static let WALLET_PIN_CONFIRM_AGAIN_TITLE = LocalizedString("wallet_pin_confirm_again_title", comment: "Please confirm your 6 digit Wallet PIN again")
    ...
    public static let WALLET_PIN_NEW_TITLE = LocalizedString("wallet_pin_new_title", comment: "Set a new Wallet PIN")
    public static let WALLET_PIN_VERIFY_TITLE = LocalizedString("wallet_pin_verify_title", comment: "Enter the 6 digit Wallet PIN to verify")
