...
public final class AppDAO {
    ...
    static let sqlQueryColumns = "a.app_id, a.app_number, a.redirect_uri, u.full_name, ifnull(a.category, '\(AppCategory.OTHER.rawValue)'), a.icon_url, a.capabilites, a.resource_patterns, a.home_uri, a.creator_id, a.updated_at"
