...
final class ExternalTransferUrlTests: XCTestCase {
    ...
    func testParseBitcoin() throws {
        ...
        let result1 = ExternalTransferUrl(url: url1)
        ...
        let result2 = ExternalTransferUrl(url: url2)
    ...
    func testParseEthereum() {
        ...
        let result4 = ExternalTransferUrl(url: url4)
        ...
        let result5 = ExternalTransferUrl(url: url5)
        ...
        let result6 = ExternalTransferUrl(url: url6)
        ...
        let result7 = ExternalTransferUrl(url: url7)
