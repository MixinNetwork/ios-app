...
FOUNDATION_EXPORT KernelTx* _Nullable KernelBuildTxToKernelAddress(NSString* _Nullable asset, NSString* _Nullable amount, int32_t threshold, NSString* _Nullable kenelAddress, NSData* _Nullable inputs, NSString* _Nullable changeKeys, NSString* _Nullable changeMask, NSString* _Nullable extra, NSString* _Nullable reference, NSError* _Nullable* _Nullable error);
