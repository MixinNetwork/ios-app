...
final class PhoneNumberParserTests: XCTestCase {
    ...
    func testUSNumberNoPrefix() {
        do {
            ...
            let phoneNumberInternationalFormat1 = phoneNumberParser.format(phoneNumber1, toType: .international, withPrefix: false)
            XCTAssertTrue(phoneNumberInternationalFormat1 == "650-253-0000")
            let phoneNumberNationalFormat1 = phoneNumberParser.format(phoneNumber1, toType: .national, withPrefix: false)
            XCTAssertTrue(phoneNumberNationalFormat1 == "(650) 253-0000")
            let phoneNumberE164Format1 = phoneNumberParser.format(phoneNumber1, toType: .e164, withPrefix: false)
            ...
            let phoneNumberInternationalFormat2 = phoneNumberParser.format(phoneNumber2, toType: .international, withPrefix: false)
            XCTAssertTrue(phoneNumberInternationalFormat2 == "800-253-0000")
            let phoneNumberNationalFormat2 = phoneNumberParser.format(phoneNumber2, toType: .national, withPrefix: false)
            XCTAssertTrue(phoneNumberNationalFormat2 == "(800) 253-0000")
            let phoneNumberE164Format2 = phoneNumberParser.format(phoneNumber2, toType: .e164, withPrefix: false)
    ...
    func testUSNumber() {
        do {
            let phoneNumber1 = try phoneNumberParser.parse("650 253 0000", withRegion: "US")
            XCTAssertNotNil(phoneNumber1)
            let phoneNumberInternationalFormat1 = phoneNumberParser.format(phoneNumber1, toType: .international)
            XCTAssertTrue(phoneNumberInternationalFormat1 == "+1 650-253-0000")
            let phoneNumberNationalFormat1 = phoneNumberParser.format(phoneNumber1, toType: .national)
            XCTAssertTrue(phoneNumberNationalFormat1 == "(650) 253-0000")
            let phoneNumberE164Format1 = phoneNumberParser.format(phoneNumber1, toType: .e164)
            XCTAssertTrue(phoneNumberE164Format1 == "+16502530000")
            let phoneNumber2 = try phoneNumberParser.parse("800 253 0000", withRegion: "US")
            XCTAssertNotNil(phoneNumber2)
            let phoneNumberInternationalFormat2 = phoneNumberParser.format(phoneNumber2, toType: .international)
            XCTAssertTrue(phoneNumberInternationalFormat2 == "+1 800-253-0000")
            let phoneNumberNationalFormat2 = phoneNumberParser.format(phoneNumber2, toType: .national)
            XCTAssertTrue(phoneNumberNationalFormat2 == "(800) 253-0000")
            let phoneNumberE164Format2 = phoneNumberParser.format(phoneNumber2, toType: .e164)
            ...
            let phoneNumberInternationalFormat3 = phoneNumberParser.format(phoneNumber3, toType: .international)
            XCTAssertTrue(phoneNumberInternationalFormat3 == "+1 900-253-0000")
            let phoneNumberNationalFormat3 = phoneNumberParser.format(phoneNumber3, toType: .national)
            XCTAssertTrue(phoneNumberNationalFormat3 == "(900) 253-0000")
            let phoneNumberE164Format3 = phoneNumberParser.format(phoneNumber3, toType: .e164)
