...
public class Localized {
    ...
    public static let WALLET_PASSWORD_INCONSISTENCY = LocalizedString("wallet_password_inconsistency", comment: "Passwords do not match")
    public static let WALLET_PASSWORD_TIPS = LocalizedString("wallet_password_tips", comment: "Please set a 6 digit PIN and remember it. If lost, there is no way to recover your wallet.")
    public static let WALLET_PASSWORD_TIPS_AGAIN = LocalizedString("wallet_password_tips_again", comment: "Please confirm the 6 digit PIN and remember it. If lost, there is no way to recover your wallet.")
    public static let WALLET_PASSWORD_TIPS_VERIFY = LocalizedString("wallet_password_tips_verify", comment: "Please enter the 6 digit PIN to verify.")
    public static let WALLET_PASSWORD_TITLE = LocalizedString("wallet_password_title", comment: "Set PIN")
    public static let WALLET_PASSWORD_COFIRM_TITLE = LocalizedString("wallet_password_cofirm_title", comment: "Confirm PIN")
