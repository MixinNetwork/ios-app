...
class TokenViewController<Token: HideableToken & ValuableToken & MaliciousDistinguishable, Transaction>: UIViewController, UITableViewDataSource, UITableViewDelegate, AssetChangeAccountRecoveryChecking {
