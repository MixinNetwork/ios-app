...
extension UserPreferenceRequest {
    ...
    static func createRequest(full_name: String? = nil, avatar_base64: String? = nil, notification_token: String? = nil, receive_message_source: String? = nil, accept_conversation_source: String? = nil, fiat_currency: String? = nil, transfer_notification_threshold: Double? = nil) -> UserPreferenceRequest {
