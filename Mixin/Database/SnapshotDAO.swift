...
final class SnapshotDAO {
    ...
    SELECT s.snapshot_id, s.type, s.asset_id, s.amount, s.counter_user_id, s.transaction_hash, s.sender, s.created_at, u.full_name as counterUserFullName, s.receiver FROM snapshots s
