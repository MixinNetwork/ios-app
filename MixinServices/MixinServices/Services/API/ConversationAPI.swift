...
public class ConversationAPI : BaseAPI {
    ...
    public func createConversation(conversation: ConversationRequest, completion: @escaping (APIResult<ConversationResponse>) -> Void) {
    ...
    public func createConversation(conversation: ConversationRequest) -> APIResult<ConversationResponse> {
    ...
    public func exitConversation(conversationId: String, completion: @escaping (APIResult<EmptyResponse>) -> Void) {
    ...
    public func addParticipant(conversationId: String, participantUserIds: [String], completion: @escaping (APIResult<ConversationResponse>) -> Void) {
    ...
    public func removeParticipant(conversationId: String, userId: String, completion: @escaping (APIResult<ConversationResponse>) -> Void) {
    ...
    public func adminParticipant(conversationId: String, userId: String, completion: @escaping (APIResult<ConversationResponse>) -> Void) {
    ...
    public func updateGroupName(conversationId: String, name: String, completion: @escaping (APIResult<ConversationResponse>) -> Void) {
    ...
    public func updateGroupAnnouncement(conversationId: String, announcement: String, completion: @escaping (APIResult<ConversationResponse>) -> Void) {
    ...
    public func updateCodeId(conversationId: String, completion: @escaping (APIResult<ConversationResponse>) -> Void) {
