...
class TradeSpotViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        layout.register(TradeSectionBackgroundView.self, forDecorationViewOfKind: TradeSectionBackgroundView.elementKind)
    ...
    @objc private func switchToAdvancedTrade(_ sender: Any) {
        tradeViewController?.switchTo(trading: .advancedSpot)
    }
    ...
    func startQuoteRequesterIfAvailable() {
...
extension TradeSpotViewController: UITextFieldDelegate {
...
extension TradeSpotViewController: TradePricingModel.Delegate {
...
extension TradeSpotViewController: SwapQuotePeriodicRequesterDelegate {
