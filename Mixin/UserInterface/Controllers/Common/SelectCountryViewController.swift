...
final class SelectCountryViewController: UIViewController {
    ...
    private let library: CountryLibrary
    ...
    init(library: CountryLibrary, selectedCountry: Country) {
        self.library = library
        self.selectedCountry = selectedCountry
        let nib = R.nib.selectCountryView
    ...
    override func viewDidLoad() {
        ...
        tableView.register(R.nib.callingCodeCell)
...
extension SelectCountryViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.calling_code, for: indexPath)!
