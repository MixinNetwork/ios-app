...
public class Localized {
    ...
    public static func WITHDRAWAL_MINIMUM_AMOUNT(amount: String) -> String {
        return String(format: LocalizedString("withdrawal_minimum_amount", comment: "Minimum withdraw amount is %@"), amount)
    }
