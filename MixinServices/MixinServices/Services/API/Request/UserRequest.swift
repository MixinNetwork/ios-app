...
public struct UserPreferenceRequest: Codable {
    ...
    public init(full_name: String? = nil, avatar_base64: String? = nil, notification_token: String? = nil, receive_message_source: String? = nil, accept_conversation_source: String? = nil, fiat_currency: String? = nil, transfer_notification_threshold: Double? = nil, transfer_confirmation_threshold: Double? = nil, accept_search_source: String? = nil) {
