...
class ScreenLockViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        unlockTipLabel.text = R.string.localizable.screen_lock_unlock(BiometryType.lockScreen.localizedName)
        unlockButton.setTitle(R.string.localizable.use_biometry(BiometryType.lockScreen.localizedName), for: .normal)
    }
