...
final class InputReferralCodeViewController: UIViewController {
    ...
    init(code: String?) {
        ...
        let nib = R.nib.inputReferralCodeView
        ...
        Task { [weak self] in
            do {
                ...
                await MainActor.run {
                    ...
                    self.isBusy = false
                    let apply = ApplyReferralCodeViewController(
                        code: info.code,
                        precentage: percentage,
                        inviter: inviter
                    )
                    presentingViewController.dismiss(animated: true) {
                        presentingViewController.present(apply, animated: true)
                    }
                }
            } catch {
                guard let self else {
...
extension InputReferralCodeViewController: UITextFieldDelegate {
...
extension InputReferralCodeViewController: UIAdaptivePresentationControllerDelegate {
...
extension InputReferralCodeViewController {
